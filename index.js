...
// -----------------------------------------------------
// This version includes enhanced error logging to help diagnose connection
// issues between the Worker and the backend PROXYIP server.
//
...
async function handleWebSocket(request, env, ctx) {
  ...
  readableStream.pipeTo(new WritableStream({
    async write(chunk, controller) {
      ...
      try {
        // <<<<< بخش هوشمند و کلیدی اینجاست >>>>>
        // The intelligent and key part is here
        ...
        // <<<<< ثبت خطای هوشمند برای دیباگ کردن >>>>>
        ...
        console.error("[Hint] Please check three things: 1) Is the PROXYIP environment variable set correctly in Cloudflare dashboard? 2) Is your backend server online? 3) Is the firewall on your backend server allowing connections from Cloudflare?");
